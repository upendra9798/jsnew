...
//The prototype property is only relevant when the function is used as a constructor (with new). 
// In this case, multipleBy5 is used as a regular function, so prototype doesn't come into play.
...
const chai = new createUser("Chai", 25) //without new not works
